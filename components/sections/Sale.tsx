...
<<<<<<< HEAD
      ...
      <h2 className='text-4xl md:text-5xl font-bold text-center text-white tracking-wider'>
        Limited Collection <br /> For Sale
      </h2>
      <p className='uppercase text-xl md:text-2xl tracking-wide font-bold bg-gradient-to-t from-indigo-900 to-indigo-600 bg-clip-text text-transparent'>
        Discounts Upto 36%
      </p>
