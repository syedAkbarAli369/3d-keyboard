  ...
  return (
    <div className='h-33 flex flex-row justify-between pr-3 md:pr-9 bg-stone-950 rounded-2xl'>
      ...
      <div className='flex flex-row gap-3 md:gap-6 items-center'>
        <div className='flex flex-col md:flex-row gap-y-3 gap-x-3 items-center bg-stone-900 px-3 py-3 md:py-1 md:px-3 rounded-full'>
...
const Cart = () => {
  ...
  const { isOpen, toggleCart, cartItems, handleAddProduct, handleDeleteProduct, handleRemoveProduct } = useCart();
      ...
      <div className='w-full max-w-4xl h-full md:h-[600px] bg-stone-800 rounded-3xl overflow-hidden'>
        ...
        {cartItems.length > 0 ? (
          <div className='w-full h-max flex flex-col md:flex-row p-3 md:p-12 gap-9'>
            <div className='h-full md:h-96 flex flex-col gap-y-3 overflow-y-auto'>
            ...
            <div className='w-full md:w-54 flex flex-col md:flex-row items-center justify-between border-t-2 md:border-t-0 md:border-l-2 border-slate-200 py-6 md:py-0 md:px-9 gap-9'>
              <p className='text-lg font-semibold text-slate-300'>Total: ${total.toFixed(2)}</p>
              <div className='p-3 flex flex-col items-center py-3 rounded-xl font-semibold bg-gradient-to-br from-rose-400 to-fuchsia-700'
